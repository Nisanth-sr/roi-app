        ...
        <>
          {tenant && (
            <section className="brand-panel p-6">
              ...
              <p className="mt-1 text-sm text-[var(--muted)]">
                Clients with margin % below this value are flagged. Default is
                20%.
                {isOwner
              ...
              {isOwner ? (
                ...
                >
                  ...
                  <LoadingButton
                    type="submit"
                    loading={saving && action === "threshold"}
                    loadingLabel="Saving…"
                    disabled={saving}
                  >
                    Save threshold
                  ...
                  <LoadingButton
                    type="button"
                    variant="ghost"
                    loading={saving && action === "recompute"}
          ...
          <section className="brand-panel p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-black">
              {members.length === 0 ? (
                <li className="text-[var(--muted)]">No team members yet.</li>
              ) : (
                members.map((m) => (
                  <li
                    key={m.user_id}
                  ...
                  >
                    ...
                    {isOwner && (
                      <LoadingButton
                        type="button"
                        variant="plain"
                        className="shrink-0 border-0 px-0 py-0 underline"
          ...
          {isOwner && (
            <section className="brand-panel p-6">
              ...
              <p className="mt-1 text-sm text-[var(--muted)]">
                ...
                <code className="text-xs">computed_cost</code> stays frozen.
                Verify against provider pricing pages before pilot data.
              </p>
